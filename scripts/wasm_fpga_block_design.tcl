...
proc create_root_design { parentCell } {
  ...
  set wasm_fpga_memory [ create_bd_cell -type ip -vlnv denisvasilik.com:denisvasilik:wasm_fpga_module:1.0 wasm_fpga_memory ]
  ...
  set wasm_fpga_stack_memory [ create_bd_cell -type ip -vlnv denisvasilik.com:denisvasilik:wasm_fpga_module:1.0 wasm_fpga_stack_memory ]
  ...
  connect_bd_intf_net -intf_net wasm_fpga_module_interconnect_M_WB [get_bd_intf_pins wasm_fpga_module_interconnect/M_WB] [get_bd_intf_pins wasm_fpga_module_memory/S_WB]
  ...
  connect_bd_net -net Clk_0_1 [get_bd_ports Clk] [get_bd_pins wasm_fpga_bus/Clk] [get_bd_pins wasm_fpga_control/Clk] [get_bd_pins wasm_fpga_engine/Clk] [get_bd_pins wasm_fpga_loader/Clk] [get_bd_pins wasm_fpga_memory/Clk] [get_bd_pins wasm_fpga_module_memory/Clk] [get_bd_pins wasm_fpga_stack/Clk] [get_bd_pins wasm_fpga_stack_memory/Clk] [get_bd_pins wasm_fpga_store/Clk] [get_bd_pins wasm_fpga_store_memory/Clk]
  ...
  connect_bd_net -net nRst_0_1 [get_bd_ports nRst] [get_bd_pins wasm_fpga_bus/nRst] [get_bd_pins wasm_fpga_control/nRst] [get_bd_pins wasm_fpga_engine/nRst] [get_bd_pins wasm_fpga_loader/nRst] [get_bd_pins wasm_fpga_memory/nRst] [get_bd_pins wasm_fpga_module_memory/nRst] [get_bd_pins wasm_fpga_stack/nRst] [get_bd_pins wasm_fpga_stack_memory/nRst] [get_bd_pins wasm_fpga_store/nRst] [get_bd_pins wasm_fpga_store_memory/nRst]
