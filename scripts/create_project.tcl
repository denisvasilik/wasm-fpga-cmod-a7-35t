...
set_property "ip_repo_paths" "[file normalize "${project_origin}/vivado-bus-abstraction-wb-ip"] [file normalize "${project_origin}/wasm-fpga-interconnect"] [file normalize "${project_origin}/wasm-fpga-memory"] [file normalize "${project_origin}/wasm-fpga-engine"] [file normalize "${project_origin}/wasm-fpga-loader"] [file normalize "${project_origin}/wasm-fpga-stack"] [file normalize "${project_origin}/wasm-fpga-store"] [file normalize "${project_origin}/wasm-fpga-bus"] [file normalize "${project_origin}/wasm-fpga-control"]" $obj
