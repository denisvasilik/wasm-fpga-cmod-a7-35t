...
create_clock -add -name ClkPin -period 83.33 -waveform {0 41.66} [get_ports {Clk}];

## LEDs
set_property -dict { PACKAGE_PIN A17   IOSTANDARD LVCMOS33 } [get_ports { Busy }]; #IO_L12N_T1_MRCC_16 Sch=led[1]
