## 12 MHz Clock Signal
set_property -dict {PACKAGE_PIN L17 IOSTANDARD LVCMOS33} [get_ports Clk12M]

## LEDs
set_property -dict {PACKAGE_PIN A17 IOSTANDARD LVCMOS33} [get_ports Active]
set_property -dict {PACKAGE_PIN C16 IOSTANDARD LVCMOS33} [get_ports Loaded]

## RGB LED
# set_property -dict { PACKAGE_PIN B17   IOSTANDARD LVCMOS33} [get_ports Active]; #IO_L14N_T2_SRCC_16 Sch=led0_b
# set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVCMOS33 } [get_ports RGB_LED2]; #IO_L13N_T2_MRCC_16 Sch=led0_g
set_property -dict {PACKAGE_PIN C17 IOSTANDARD LVCMOS33} [get_ports Trap]

## Buttons
set_property -dict {PACKAGE_PIN A18 IOSTANDARD LVCMOS33} [get_ports Rst]
#set_property -dict { PACKAGE_PIN B18 IOSTANDARD LVCMOS33 } [get_ports Run]; #IO_L19P_T3_16 Sch=btn[1]
...
## UART
set_property -dict {PACKAGE_PIN J18 IOSTANDARD LVCMOS33} [get_ports UartTx]
set_property -dict {PACKAGE_PIN J17 IOSTANDARD LVCMOS33} [get_ports UartRx]

## Crypto 1 Wire Interface
#set_property -dict { PACKAGE_PIN D17   IOSTANDARD LVCMOS33 } [get_ports { crypto_sda }]; #IO_0_14 Sch=crypto_sda

## QSPId
set_property -dict {PACKAGE_PIN K19 IOSTANDARD LVCMOS33} [get_ports nCs]
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports MoSi]
set_property -dict {PACKAGE_PIN D19 IOSTANDARD LVCMOS33} [get_ports MiSo]
set_property -dict {PACKAGE_PIN G18 IOSTANDARD LVCMOS33} [get_ports nWp]
set_property -dict {PACKAGE_PIN F18 IOSTANDARD LVCMOS33} [get_ports nHold]
set_property -dict {PACKAGE_PIN E19 IOSTANDARD LVCMOS33} [get_ports SClk]
